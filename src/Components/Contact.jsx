    ...
    className="my-20 min-h-96 w-screen px-10">
        ...
        text-blue-50 sm:overflow-hidden">
            ...
            w-72 overflow-hidden sm:block lg:left-20 lg:w-96">
              ...
              <ImageClipBox
               clipClass="contact-clip-path-2 lg:tranlate-y-40
               translate-y-60"
            ...
            <div className="absolute left-20 -top-40 w-60 sm:top-1/2 
            md:left-auto md:right-10 lg:top-20 lg:w-80 z-50 ">
